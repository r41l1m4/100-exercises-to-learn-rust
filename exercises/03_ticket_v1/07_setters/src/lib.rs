...
impl Ticket {
    ...
    fn is_description_valid(description: &str) {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Self::is_valid(&title, &description, &status);
        Ticket {
            title,
            description,
            status,
